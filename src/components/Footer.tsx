      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray text-sm mb-6 max-w-xs">
              Central Florida&apos;s trusted roofing contractor. Licensed,
              insured, and committed to protecting your home.
            </p>
            <p className="text-gray text-sm">License #CCC1334209</p>
            <div className="flex gap-3 mt-6">
              <a
                href="https://facebook.com/people/Gravity-Roofing/100087923692656/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-purple/20 rounded-lg flex items-center justify-center text-gray hover:text-white transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://instagram.com/gravity.roofing/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-purple/20 rounded-lg flex items-center justify-center text-gray hover:text-white transition-colors"
              ...
              <a
                href="https://youtube.com/@gravityroofing"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-purple/20 rounded-lg flex items-center justify-center text-gray hover:text-white transition-colors"
                aria-label="YouTube"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="tel:4074610234"
                  className="flex items-start gap-3 text-gray text-sm hover:text-white transition-colors"
                >
                  <svg
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray text-xs">
            &copy; {new Date().getFullYear()} Gravity Roofing, LLC. All rights
            reserved.
          </p>
          <p className="text-gray text-xs">
            Licensed &amp; Insured &bull; CCC1334209
          </p>
        </div>
      </div>
    </footer>
